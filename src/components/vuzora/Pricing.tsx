        ...
        <div className="grid gap-12 md:grid-cols-12 md:gap-16">
          <div className="md:col-span-5">
            <SectionHeader
              ...
              lede="До 31 октября 2026 – бесплатно для всех. Дальше – две недели пробного периода для новых пользователей и символическая подписка, чтобы Vuzora жил без рекламы и сторонних трекеров."
              titleMaxCh={20}
              className="mb-10"
            />
            <LaunchTimeline />
