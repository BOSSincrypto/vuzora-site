...
export const CHANGELOG: readonly ChangelogEntry[] = [
  {
    date: "2026-09-14",
    tag: "Вузы",
    title: "ГУУ, МосПолитех и МИИГАиК в работе",
    bullets: [
      "Государственный университет управления, Московский политехнический университет и Московский государственный университет геодезии и картографии — онлайн, реестр вырос до 28 вузов.",
      "У каждого вуза своя страница с утренним сценарием, статусом и точной ссылкой подключения.",
    ],
  },
  {
    date: "2026-06-28",
  ...
  },
  {
    ...
    bullets: ["Интерактивный слайдер показывает, сколько минут в год экономит Vuzora."],
  },
  {
    date: "2026-05-30",
    tag: "Подписка",
    ...
    bullets: [
      ...
      "Бесплатно до 31 октября 2026, дальше – 14 дней пробного периода для новых пользователей.",
    ],
  },
  {
    date: "2026-04-10",
