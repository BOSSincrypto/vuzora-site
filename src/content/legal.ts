      ...
      blocks: [
        {
          ...
          text:
            ...
            "присылает Пользователю расписание его занятий на основе открытых данных вузов. " +
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "Выбранный вуз, факультет, курс и группа – чтобы знать, какое расписание отправлять.",
